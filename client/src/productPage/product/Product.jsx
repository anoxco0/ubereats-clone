  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ display: page.openPage ? "block" : "none" }}
      ></div>
      <div
        ref={buttonRef}
        style={{
      ...
      <div className="mdiv">
        <div className="ldiv">
          ...
          <div className="sort">
            <h3>Sort</h3>
            <input className="round" type="checkbox" defaultChecked /> Picked
            for you (default)<br></br>
            <input className="round" type="checkbox" onChange={rating} /> Most
            popular<br></br>
            <input className="round" type="checkbox" onChange={ratd} /> Rating
            <br></br>
            <input className="round" type="checkbox" onChange={time} /> Delivery
            time
          </div>
          <div>
        ...
        <div className="rdiv">
          ...
          <div style={{ display: "flex" }}>
            {grocery.map((e) => {
              return (
                <div key={nanoid()} className="grocery">
                  <img height="150px" width="250px" src={e.img} alt="" />
                  <div>{e.title}</div>
                </div>
              );
            })}
                ...
                <Link className="link" key={e.id} to={`/product/${e.id}`}>
                  <div className="prduct" key={e._id}>
                    <div className="pdimage">
                      <img height="190px" width="270px" src={e.img} alt="" />
                    </div>
                    <div style={{ display: "flex" }}>
